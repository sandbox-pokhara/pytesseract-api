...
from pytesseract_api.capi_types import *
...
class CpyAPI:
    ...
    def TessTextRendererCreate(
        ...
        self.TESSERACT.TessTextRendererCreate.restype = POINTER(
            TessResultRenderer
        )
    ...
    def TessHOcrRendererCreate(
        ...
        self.TESSERACT.TessHOcrRendererCreate.restype = POINTER(
            TessResultRenderer
        )
    ...
    def TessHOcrRendererCreate2(
        ...
        self.TESSERACT.TessHOcrRendererCreate2.restype = POINTER(
            TessResultRenderer
        )
    ...
    def TessAltoRendererCreate(
        ...
        self.TESSERACT.TessAltoRendererCreate.restype = POINTER(
            TessResultRenderer
        )
    ...
    def TessTsvRendererCreate(
        ...
        self.TESSERACT.TessTsvRendererCreate.restype = POINTER(
            TessResultRenderer
        )
    ...
    def TessPDFRendererCreate(
        ...
        self.TESSERACT.TessPDFRendererCreate.restype = POINTER(
            TessResultRenderer
        )
        self.TESSERACT.TessPDFRendererCreate.argtypes = [
            c_char_p,
            c_char_p,
            c_bool,
        ]
        return self.TESSERACT.TessPDFRendererCreate(
            outputbase, datadir, textonly
        )

    def TessUnlvRendererCreate(
        self, outputbase: c_char_p
    ) -> POINTER(TessResultRenderer):
        self.TESSERACT.TessUnlvRendererCreate.restype = POINTER(
            TessResultRenderer
        )
    ...
    def TessBoxTextRendererCreate(
        ...
        self.TESSERACT.TessBoxTextRendererCreate.restype = POINTER(
            TessResultRenderer
        )
    ...
    def TessLSTMBoxRendererCreate(
        ...
        self.TESSERACT.TessLSTMBoxRendererCreate.restype = POINTER(
            TessResultRenderer
        )
    ...
    def TessResultRendererInsert(
        ...
        next: POINTER(TessResultRenderer),
    ) -> None:
    ...
    def TessResultRendererNext(
        ...
        self.TESSERACT.TessResultRendererNext.restype = POINTER(
            TessResultRenderer
        )
        self.TESSERACT.TessResultRendererNext.argtypes = [
            POINTER(TessResultRenderer)
        ]
    ...
    def TessResultRendererTitle(
        ...
        self.TESSERACT.TessResultRendererTitle.argtypes = [
            POINTER(TessResultRenderer)
        ]
    ...
    def TessBaseAPIGetOpenCLDevice(
        self, device: POINTER(c_void_p)
    ) -> c_size_t:
        handle = self._handle
    ...
    def TessBaseAPIGetInputName(self) -> c_char_p:
        ...
        self.TESSERACT.TessBaseAPIGetInputName.argtypes = [
            POINTER(TessBaseAPI)
        ]
    ...
    def TessBaseAPIGetInputImage(self) -> POINTER(Pix):
        ...
        self.TESSERACT.TessBaseAPIGetInputImage.argtypes = [
            POINTER(TessBaseAPI)
        ]
    ...
    def TessBaseAPIGetSourceYResolution(self) -> c_int:
        ...
        self.TESSERACT.TessBaseAPIGetSourceYResolution.argtypes = [
            POINTER(TessBaseAPI)
        ]
    ...
    def TessBaseAPISetVariable(
        self, name: c_char_p, value: c_char_p
    ) -> c_bool:
        handle = self._handle
    ...
    def TessBaseAPISetDebugVariable(
        self, name: c_char_p, value: c_char_p
    ) -> c_bool:
        handle = self._handle
    ...
    def TessBaseAPIInit3(
        self, datapath: c_char_p, language: c_char_p
    ) -> c_int:
        handle = self._handle
    ...
    def TessBaseAPIGetAvailableLanguagesAsVector(self) -> c_void_p:
        handle = self._handle
        self.TESSERACT.TessBaseAPIGetAvailableLanguagesAsVector.restype = (
            c_void_p
        )
    ...
    def TessBaseAPIInitForAnalysePage(self) -> None:
        ...
        self.TESSERACT.TessBaseAPIInitForAnalysePage.argtypes = [
            POINTER(TessBaseAPI)
        ]
    ...
    def TessBaseAPIGetPageSegMode(self) -> TessPageSegMode:
        ...
        self.TESSERACT.TessBaseAPIGetPageSegMode.argtypes = [
            POINTER(TessBaseAPI)
        ]
    ...
    def TessBaseAPISetRectangle(
        ...
        return self.TESSERACT.TessBaseAPISetRectangle(
    ...
    def TessBaseAPIGetThresholdedImage(self) -> POINTER(Pix):
        ...
        self.TESSERACT.TessBaseAPIGetThresholdedImage.argtypes = [
            POINTER(TessBaseAPI)
        ]
        return self.TESSERACT.TessBaseAPIGetThresholdedImage(handle)

    def TessBaseAPIGetRegions(
        self, pixa: POINTER(POINTER(Pixa))
    ) -> POINTER(Boxa):
        handle = self._handle
    ...
    def TessBaseAPIGetConnectedComponents(
        ...
        handle = self._handle
        self.TESSERACT.TessBaseAPIGetConnectedComponents.restype = POINTER(
            Boxa
        )
    ...
    def TessBaseAPIGetThresholdedImageScaleFactor(self) -> c_int:
        handle = self._handle
        self.TESSERACT.TessBaseAPIGetThresholdedImageScaleFactor.restype = (
            c_int
        )
    ...
    def TessBaseAPIAnalyseLayout(self) -> POINTER(TessPageIterator):
        handle = self._handle
        self.TESSERACT.TessBaseAPIAnalyseLayout.restype = POINTER(
            TessPageIterator
        )
        self.TESSERACT.TessBaseAPIAnalyseLayout.argtypes = [
            POINTER(TessBaseAPI)
        ]
    ...
    def TessBaseAPIGetIterator(self) -> POINTER(TessResultIterator):
        handle = self._handle
        self.TESSERACT.TessBaseAPIGetIterator.restype = POINTER(
            TessResultIterator
        )
    ...
    def TessBaseAPIGetMutableIterator(self) -> POINTER(TessMutableIterator):
        ...
        self.TESSERACT.TessBaseAPIGetMutableIterator.argtypes = [
            POINTER(TessBaseAPI)
        ]
    ...
    def TessBaseAPIGetHOCRText(self, page_number: c_int) -> c_char_p:
        ...
        self.TESSERACT.TessBaseAPIGetHOCRText.argtypes = [
            POINTER(TessBaseAPI),
            c_int,
        ]
    ...
    def TessBaseAPIGetAltoText(self, page_number: c_int) -> c_char_p:
        ...
        self.TESSERACT.TessBaseAPIGetAltoText.argtypes = [
            POINTER(TessBaseAPI),
            c_int,
        ]
    ...
    def TessBaseAPIGetTsvText(self, page_number: c_int) -> c_char_p:
        ...
        self.TESSERACT.TessBaseAPIGetTsvText.argtypes = [
            POINTER(TessBaseAPI),
            c_int,
        ]
    ...
    def TessBaseAPIGetBoxText(self, page_number: c_int) -> c_char_p:
        ...
        self.TESSERACT.TessBaseAPIGetBoxText.argtypes = [
            POINTER(TessBaseAPI),
            c_int,
        ]
    ...
    def TessBaseAPIMeanTextConf(self) -> c_int:
        ...
        self.TESSERACT.TessBaseAPIMeanTextConf.argtypes = [
            POINTER(TessBaseAPI)
        ]
    ...
    def TessBaseAPIAllWordConfidences(self) -> POINTER(c_int):
        ...
        self.TESSERACT.TessBaseAPIAllWordConfidences.argtypes = [
            POINTER(TessBaseAPI)
        ]
    ...
    def TessBaseAPIGetTextDirection(
        ...
        return self.TESSERACT.TessBaseAPIGetTextDirection(
            handle, out_offset, out_slope
        )

    def TessBaseAPIGetUnichar(self, unichar_id: c_int) -> c_char_p:
        handle = self._handle
        self.TESSERACT.TessBaseAPIGetUnichar.restype = c_char_p
        self.TESSERACT.TessBaseAPIGetUnichar.argtypes = [
            POINTER(TessBaseAPI),
            c_int,
        ]
    ...
    def TessBaseAPIClearPersistentCache(self) -> None:
        ...
        self.TESSERACT.TessBaseAPIClearPersistentCache.argtypes = [
            POINTER(TessBaseAPI)
        ]
    ...
    def TessBaseAPISetMinOrientationMargin(self, margin: c_double) -> None:
        ...
        return self.TESSERACT.TessBaseAPISetMinOrientationMargin(
            handle, margin
        )
    ...
    def TessPageIteratorDelete(self) -> None:
        ...
        self.TESSERACT.TessPageIteratorDelete.argtypes = [
    ...
    def TessPageIteratorCopy(self) -> POINTER(TessPageIterator):
        ...
        self.TESSERACT.TessPageIteratorCopy.argtypes = [
            POINTER(TessPageIterator)
        ]
    ...
    def TessPageIteratorBegin(self) -> None:
        ...
        self.TESSERACT.TessPageIteratorBegin.argtypes = [
            POINTER(TessPageIterator)
        ]
    ...
    def TessPageIteratorIsAtBeginningOf(
    ...
    def TessPageIteratorIsAtFinalElement(
        ...
        return self.TESSERACT.TessPageIteratorIsAtFinalElement(
            handle, level, element
        )
    ...
    def TessPageIteratorBlockType(self) -> TessPolyBlockType:
        ...
        self.TESSERACT.TessPageIteratorBlockType.argtypes = [
            POINTER(TessPageIterator)
        ]
    ...
    def TessPageIteratorBaseline(
        ...
        return self.TESSERACT.TessPageIteratorBaseline(
            handle, level, x1, y1, x2, y2
        )
    ...
    def TessResultIteratorDelete(self) -> None:
        ...
        self.TESSERACT.TessResultIteratorDelete.argtypes = [
    ...
    def TessResultIteratorCopy(self) -> POINTER(TessResultIterator):
        handle = self._handle
        self.TESSERACT.TessResultIteratorCopy.restype = POINTER(
            TessResultIterator
        )
        self.TESSERACT.TessResultIteratorCopy.argtypes = [
            POINTER(TessResultIterator)
        ]
    ...
    def TessResultIteratorGetPageIteratorConst(
        self,
    ) -> POINTER(TessPageIterator):
        handle = self._handle
        self.TESSERACT.TessResultIteratorGetPageIteratorConst.restype = (
            POINTER(TessPageIterator)
        )
    ...
    def TessResultIteratorGetChoiceIterator(
        self,
    ...
    def TessResultIteratorGetUTF8Text(
        self, level: TessPageIteratorLevel
    ) -> c_char_p:
        handle = self._handle
    ...
    def TessResultIteratorConfidence(
        self, level: TessPageIteratorLevel
    ) -> c_float:
        handle = self._handle
    ...
    def TessResultIteratorWordRecognitionLanguage(self) -> c_char_p:
        handle = self._handle
        self.TESSERACT.TessResultIteratorWordRecognitionLanguage.restype = (
            c_char_p
        )
    ...
    def TessChoiceIteratorDelete(self) -> None:
        ...
        self.TESSERACT.TessChoiceIteratorDelete.argtypes = [
            POINTER(TessChoiceIterator)
        ]
    ...
    def TessChoiceIteratorNext(self) -> c_bool:
        ...
        self.TESSERACT.TessChoiceIteratorNext.argtypes = [
            POINTER(TessChoiceIterator)
        ]
    ...
    def TessMonitorGetCancelThis(
        self, monitor: POINTER(ETEXT_DESC)
    ) -> c_void_p:
        self.TESSERACT.TessMonitorGetCancelThis.restype = c_void_p
        self.TESSERACT.TessMonitorGetCancelThis.argtypes = [
            POINTER(ETEXT_DESC)
        ]
